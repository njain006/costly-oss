...
* **snowflake:** correct invalid ACCOUNT_USAGE column names in cost queries ([127e07c](https://github.com/njain006/costly-oss/commit/127e07c1d8323a4bc1800c4d184c488b3af6568b))
* **snowflake:** correct invalid ACCOUNT_USAGE column names in cost queries ([658a047](https://github.com/njain006/costly-oss/commit/658a047e21ba32ca1ac81ce5226803516029518a))
* **snowflake:** decrypt all credential fields in the platform-&gt;legacy adapter ([76260ec](https://github.com/njain006/costly-oss/commit/76260ecf01e4dcaaee26a2405dcaa4476316451c))
* **snowflake:** decrypt credential fields in the platform-&gt;legacy conn adapter (JWT invalid) ([d7c3a41](https://github.com/njain006/costly-oss/commit/d7c3a41597a59153960bc5fe2d771fc15f8fc238))
* **snowflake:** degrade dashboard gracefully when a query view is denied ([c154417](https://github.com/njain006/costly-oss/commit/c154417e04bb2820003433f80d2cd1398e5e7909))
* **snowflake:** degrade dashboard gracefully when a query view is denied ([8d8a1fb](https://github.com/njain006/costly-oss/commit/8d8a1fbdd63c53ec70ccb902b6b8a18d6a02f2a7))
* **snowflake:** stop assuming ACCOUNTADMIN and correct grant guidance ([0f1ae1e](https://github.com/njain006/costly-oss/commit/0f1ae1ed0e59a45a15715ac48d79b519396a3439))
* **snowflake:** stop assuming ACCOUNTADMIN role & correct grant guidance ([06210aa](https://github.com/njain006/costly-oss/commit/06210aa765bfb15932d06e78de47ec67f9ea9c21))
