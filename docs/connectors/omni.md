...
Contract tests for this connector live at `backend/tests/contract/test_omni.py`
and load JSON fixtures from `backend/tests/fixtures/omni/`. The fixtures are
...
To capture fresh fixtures against a real Omni Analytics account when the API
