...
Contract tests for this connector live at `backend/tests/contract/test_monte_carlo.py`
and load JSON fixtures from `backend/tests/fixtures/monte_carlo/`. The fixtures are
...
To capture fresh fixtures against a real Monte Carlo account when the API
