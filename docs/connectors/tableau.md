...
Contract tests for this connector live at `backend/tests/contract/test_tableau.py`
and load JSON fixtures from `backend/tests/fixtures/tableau/`. The fixtures are
...
To capture fresh fixtures against a real Tableau account when the API
