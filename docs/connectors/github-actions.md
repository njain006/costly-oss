...
Contract tests for this connector live at `backend/tests/contract/test_github.py`
and load JSON fixtures from `backend/tests/fixtures/github/`. The fixtures are
...
To capture fresh fixtures against a real GitHub Actions account when the API
